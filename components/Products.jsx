...
export const Products = () => {
 ...
 //console.log(data)
    const search_handle = (val) => {
       const Search_item = products_data.filter((current)=>{
    ...
    const sort_products_handle = (val) => {
     ...
     let Sorted_method = ""
     if(val === 2){
        Sorted_method = [...products_data].sort((a,b)=>a.price-b.price ) 
     }else{
        Sorted_method = [...products_data].sort((a,b)=>b.price-a.price )
     }
     setData(Sorted_method)
        //   data.sort()
        //   console.log(data)
    }
